...
# --force-rm komutu, oluşan gereksiz ara konteynrlari siliyor, silmezse serveri şişiriyor, yeni docker versiyonlarnda bu komutu yazmadan da silebiliyor, yazmasak da olur.